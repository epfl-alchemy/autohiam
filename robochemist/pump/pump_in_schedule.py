...
def upload_sketch(sketch_path, board_fqbn, port):
    try:
        ...
        with serial.Serial(port, baudrate=9600, timeout=1) as ser:
            ...
            while time.time() - start_time < 150:  # Read for up to 130 seconds
                if ser.in_waiting:
...
# upload_sketch(
#     sketch_path="/home/szhuang/autohiam_ws/src/robochemist/pump/pump_in_iron",
#     board_fqbn="arduino:avr:uno",
#     port="/dev/ttyACM0"
# )
# print("New iron has been pumped in.")

upload_sketch(
    sketch_path="/home/szhuang/autohiam_ws/src/robochemist/pump/pump_in_ammonia",
    board_fqbn="arduino:avr:uno",
    port="/dev/ttyACM0"
)
print("New ammonia has been pumped in.")
