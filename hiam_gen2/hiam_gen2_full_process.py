...
def infusion():
    ...
    print("Going to find the iron cover...")
    ...
    print("Moving to a safer position...")
    subprocess.run(cmd_start_pose, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)

    print("Moving the cover to the base...")
    subprocess.run(cmd_move_to_iron_cover_base, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    print("Going to find the sample container...")
    subprocess.run(cmd_start_pose, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    print("Moving to dry...")
    subprocess.run(cmd_move_to_dry, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    print("Going to find the heater...")
    subprocess.run(cmd_start_pose, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    subprocess.run(cmd_cartesian_move_down_heater, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
...
def precipitation():
    ...
    print("Moving to dry...")
    subprocess.run(cmd_move_to_dry_iron, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    ...
    print("Moving to the ammonia...")
    subprocess.run(cmd_move_to_ammonia, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
...
def washing():
    ...
    print("Moving to the water...")
    subprocess.run(cmd_move_to_water, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
...
def transition():
    ...
    print("Moving to the original container...")
    subprocess.run(cmd_move_to_origin, shell=True, executable="/bin/bash", check=True, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
