...
class TrajectoryClient(Node):
    def __init__(self):
        ...
        self.declare_parameter('x', 0.335)
        self.declare_parameter('y', 0.135)
        self.declare_parameter('z', 0.300)
    ...
    def send_request(self):
        ...
        request.goal_pose.orientation.w = 0.6519127 #0.58547 #0.7071
        request.goal_pose.orientation.x = -0.0024165 #0.012608 #0.0
        request.goal_pose.orientation.y = 0.7582691 #0.810592 #0.7071
        request.goal_pose.orientation.z = 0.0056522 #0.001656 #0.0
