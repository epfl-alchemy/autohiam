...
class MoveIntoHeater(Node):
    ...
    def marker_listener_callback(self, msg: MarkerPoseWithID):
        ...
        x, y, z, qw, qx, qy, qz = self.compute_target_pose(
                ...
                x_offset=0.0,
                y_offset=0.0,
                z_offset=0.204, #0.204 0.120
        )
        goal_pose = Pose()
        goal_pose.position.x = x
        goal_pose.position.y = y
        goal_pose.position.z = z
        goal_pose.orientation.w = 0.6519127 #0.58547 #0.7071
        goal_pose.orientation.x = -0.0024165 #0.012608 #0.0
        goal_pose.orientation.y = 0.7582691 #0.810592 #0.7071
        goal_pose.orientation.z = 0.0056522 #0.001656 #0.0
