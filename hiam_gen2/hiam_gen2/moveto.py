...
class TrajectoryClient(Node):
    ...
    def send_request(self):
        ...
        request.goal_pose.orientation.w = 0.7071 #0.58547 #0.7071
        request.goal_pose.orientation.x = 0.0 #0.012608 #0.0
        request.goal_pose.orientation.y = 0.7071 #0.810592 #0.7071
        request.goal_pose.orientation.z = 0.0 #0.001656 #0.0
